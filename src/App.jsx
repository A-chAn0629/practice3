    ...
    <header className="hero is-dark is-bold">
      <div className="hero-body">
        <div className="container">
          <h1 className="title">Cute Dog & Cat & Bird Images</h1>
          <h2>日本大学文理学部情報科学科 Webプログラミングの演習課題 5421052 飯田愛結</h2>
        </div>
      </div>
    </header>
  );
  ...
  return (
    <footer className="footer">
      <div className="content has-text-centered">
        <p>Animal images are retrieved from Shibe.Online API</p>
        <p>
